// Generated from WHATWG entities.json. DO NOT EDIT BY HAND.
// 2,231 entities, sorted alphabetically for binary search.

/// Sorted array of (entity_name, resolved_characters).
/// Entity name does NOT include leading `&`.
...
pub(crate) fn resolve_named_entity(name: &str) -> Option<&'static str> {
    ENTITIES.binary_search_by_key(&name, |&(n, _)| n)
        .ok()
